...
def parse_incomplete_json(json_string):
    ...
    json_objects = re.findall(json_regex, json_string)
    ...
    for obj in json_objects:
        try:
            ...
            print(f"Failed to parse object: {obj}")
...
def main():
    video_id='LMnrH1CN4oc'  # Replace with your video's URL
    ...
    content = interesting_segment
    parsed_content = parse_incomplete_json(content)
